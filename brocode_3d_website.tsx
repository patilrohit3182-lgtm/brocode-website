    ...
    <div className="relative bg-black text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex space-x-8">
              {['home', 'about', 'highlights', 'tracks', 'register', 'team'].map(section => (
                <button
                  key={section}
      ...
      <section id="about" className="py-20 px-4 bg-gradient-to-b from-black via-purple-900/10 to-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: <Code size={40} />, title: '48 Hours', desc: 'Non-stop coding marathon' },
              { icon: <Users size={40} />, title: '500+ Coders', desc: 'From across the nation' },
              { icon: <Trophy size={40} />, title: '$50K Prizes', desc: 'Win amazing rewards' }
            ].map((item, i) => (
              <div 
                key={i}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className={`h-2 w-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${track.color}`}></div>
      ...
      <section id="register" className="py-20 px-4">
        <div className="max-w-2xl mx-auto">
          ...
          <form className="glass neon-border rounded-2xl p-8 space-y-6 reveal">
            <div>
              <input 
                type="text" 
      ...
      <section id="team" className="py-20 px-4 bg-gradient-to-b from-black via-purple-900/10 to-black">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {['Alex Chen', 'Sarah Kim', 'Marcus Rodriguez', 'Emily Zhang'].map((name, i) => (
              <div 
                key={i}
              ...
              >
                ...
                <div className="flex justify-center space-x-3">
                  <Github size={20} className="text-gray-400 hover:text-cyan-400 cursor-pointer transition-colors" />
                  <Twitter size={20} className="text-gray-400 hover:text-cyan-400 cursor-pointer transition-colors" />
                  <Linkedin size={20} className="text-gray-400 hover:text-cyan-400 cursor-pointer transition-colors" />
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">The ultimate coding challenge for developers who dare to dominate.</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4 text-cyan-400">Quick Links</h4>
              <div className="space-y-2">
                {['About', 'Tracks', 'Register', 'Contact'].map(link => (
                  <button key={link} className="block text-gray-400 hover:text-cyan-400 transition-colors">
                    {link}
                  </button>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                <p className="flex items-center"><Mail size={16} className="mr-2" /> hello@brocode.dev</p>
                <div className="flex space-x-4 mt-4">
                  <Github size={24} className="hover:text-cyan-400 cursor-pointer transition-colors" />
                  <Twitter size={24} className="hover:text-cyan-400 cursor-pointer transition-colors" />
                  <Linkedin size={24} className="hover:text-cyan-400 cursor-pointer transition-colors" />
                </div>
              </div>
            </div>
          </div>
